...
{
    /// <summary>
    /// Controlador del módulo de reasignación de tareas de solicitudes de pago.
    /// </summary>
    [SesionFilter]
    public class ReasignacionTareasPagoController : Controller
    {
        ...
        public JsonResult ObtenerTareasPorResponsable(string UsuarioResponsable)
        {
            ...
            try
            {
                Tareas = ReasignacionTareasPagoBLL.ObtenerTareasPorResponsable(UsuarioResponsable, db);
            }
            catch (Exception e)
            {
                validacion.Add(e.Message);
            ...
            string ResponsableAnterior)
        {
            ...
            using (var dbcxtransaction = db.Database.BeginTransaction())
            {
                try
                {
                    ReasignacionTareasPagoBLL.Reasignar(TareasReasignar, ResponsableNuevo, ResponsableAnterior, db, sesion);
