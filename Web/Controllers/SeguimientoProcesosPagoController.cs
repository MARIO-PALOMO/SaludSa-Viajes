...
{
    /// <summary>
    /// Controlador del módulo de reportes de seguimiento de procesos de solicitudes de pago.
    /// </summary>
    [SesionFilter]
    public class SeguimientoProcesosPagoController : Controller
    {
        ...
        public JsonResult ObtenerMetadatos()
        {
            ...
            try
            {
                ...
                Originadores = SeguimientoProcesosPagoBLL.ObtenerOriginadores(EmpresaActual.Codigo, db);
            }
            catch (Exception e)
            {
        ...
        public JsonResult ObtenerOriginadores(string EmpresaCodigo)
        {
            ...
            try
            {
                Originadores = SeguimientoProcesosPagoBLL.ObtenerOriginadores(EmpresaCodigo, db);
            }
            catch (Exception e)
            {
                validacion.Add(e.Message);
            ...
            DateTime FechaHasta)
        {
            ...
            try
            {
                Solicitudes = SeguimientoProcesosPagoBLL.ObtenerSolicitudes(EmpresaCodigo, Originadores, FechaDesde, FechaHasta, db);
            }
            catch (Exception e)
            {
                validacion.Add(e.Message);
