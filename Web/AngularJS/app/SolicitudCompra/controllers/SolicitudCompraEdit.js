...
/**
 * Gestiona la lógica de control de la vista edit del módulo Solicitud Compra.
 */
app_solicitud_compra.controller('SolicitudCompraEdit', [
    '$scope',
    '$rootScope',
    '$uibModal',
    '$log',
	...
	function ($scope, $rootScope, $uibModal, $log, $http, json_js_datetime, Persistencia, $window) {
		...
		$scope.Crear = function (accion) {
			...
			if (Validacion) {
				...
				Persistencia.Edit($scope.Solicitud.RequerimientosAdjuntos, Cabecera)
