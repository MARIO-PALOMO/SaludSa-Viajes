...
/**
 * Gestiona la lógica de control de la vista clonar del módulo Solicitud Compra.
 */
app_solicitud_compra.controller('SolicitudCompraClonar', [
    '$scope',
    '$rootScope',
    '$uibModal',
    '$log',
		...
		$scope.AdicionarDistribucion = function (Detalle) {
			...
			if (Detalle.PlantillaDistribucionDetalle && Detalle.PlantillaDistribucionDetalle.length > 0) {
				var modalInstance = $uibModal.open({
					...
					resolve: {
						data: {
							TituloPag: $scope.Data.Accion == 'detail' ? 'Detalle de distribución' : 'Adicionar distribución',
							Accion: $scope.Data.Accion == 'detail' ? 'detail' : 'create',
							DesdeSolicitud: true,
