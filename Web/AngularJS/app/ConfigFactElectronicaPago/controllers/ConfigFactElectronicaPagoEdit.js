...
/**
 * Gestiona la lógica de control de la vista edit y detail del módulo Configuración de Factura Electrónica.
 */
app_config_fact_electronica_pago.controller('ConfigFactElectronicaPagoEdit', [
    '$scope',
    '$rootScope',
    '$uibModal',
    '$uibModalInstance',
