...
/**
 * Gestiona la lógica de control de la vista DevueltaSolicitanteJefeEdit del módulo Tarea Pago.
 */
app_tarea_pago.controller('DevueltaSolicitanteJefeEdit', [
    '$scope',
    '$rootScope',
    '$uibModal',
    '$log',
	...
	function ($scope, $rootScope, $uibModal, $log, $http, json_js_datetime, json_js_date, PersistenciaPago, $window) {
		...
		$scope.Crear = function () {
			...
			if ($scope.ValidarEnviar()) {
				...
				PersistenciaPago.EditTarea(Files, Cabecera, $scope.FacturasEliminar, $scope.FacturasEliminarAdjunto, $scope.TareaId)
