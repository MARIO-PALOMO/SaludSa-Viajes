...
{
    /// <summary>
    /// Cliente rest para cuentas contables.
    /// </summary>
    public class CuentaContableRCL
    {
        /// <summary>
            ...
            string CompaniaCodigo)
        {
            ...
            var reques = new RestRequest("ServicioAdministracion/api/DynamicsAx/ObtenerTiposPago", Method.GET);
            ...
            List<CuentaContableViewModel> cuentasContable = new List<CuentaContableViewModel>();

            var json = JsonConvert.SerializeObject(new
            {
                origin = "ServicioAdministracion/api/DynamicsAx/ObtenerTiposPago",
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                var error = string.Format("Error al intentar consumir el servicio web \"ServicioAdministracion/api/DynamicsAx/ObtenerTiposPago\". Código de error: {0} - Descripción: {1}. " + mensaje, response.StatusCode, response.StatusDescription);

                EventLogUtil.EscribirLogErrorWeb(json, 35, sesion.OrigenLog);
            ...
            else
            {
                ...
                if (Content != null && Content.Datos != null)
                {
                    ...
                    {
                        cuentasContable = JsonConvert.DeserializeObject<List<CuentaContableViewModel>>(Content.Datos.ToString());
                    }
                }
                else
                {
                    ...
                    {
                        var error = "Error en la respuesta obtenida al consultar el servicio: /ServicioAdministracion/api/DynamicsAx/ObtenerTiposPago";
                        EventLogUtil.EscribirLogErrorWeb(json, 35, sesion.OrigenLog);
                        throw new Exception(error);
                    }
                }
            ...
            EventLogUtil.EscribirLogInfoWeb(json, 35, sesion.OrigenLog);
