...
{
    /// <summary>
    /// Cliente rest para categorías de proyecto.
    /// </summary>
    public class CategoriaProyectoPagoRCL
    {
        /// <summary>
            ...
            string codigoCompania)
        {
            ...
            var reques = new RestRequest("ServicioAdministracion/api/DynamicsAx/ObtenerCategoriaProyectos", Method.GET);
            ...
            List<CategoriaProyectoPagoViewModel> items = new List<CategoriaProyectoPagoViewModel>();

            var json = JsonConvert.SerializeObject(new
            {
                origin = "ServicioAdministracion/api/DynamicsAx/ObtenerCategoriaProyectos",
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                var error = string.Format("Error al intentar consumir el servicio web \"ServicioAdministracion/api/DynamicsAx/ObtenerCategoriaProyectos\". Código de error: {0} - Descripción: {1}. " + mensaje, response.StatusCode, response.StatusDescription);

                EventLogUtil.EscribirLogErrorWeb(json, 44, sesion.OrigenLog);
            ...
            else
            {
                ...
                if (Content != null && Content.Datos != null)
                {
                    ...
                    {
                        items = JsonConvert.DeserializeObject<List<CategoriaProyectoPagoViewModel>>(Content.Datos.ToString());
                    }
                }
                else
                {
                    ...
                    {
                        var error = "Error en la respuesta obtenida al consultar el servicio: /ServicioAdministracion/api/DynamicsAx/ObtenerCategoriaProyectos";
                        EventLogUtil.EscribirLogErrorWeb(json, 44, sesion.OrigenLog);
                        throw new Exception(error);
                    }
                }
            ...
            EventLogUtil.EscribirLogInfoWeb(json, 44, sesion.OrigenLog);
