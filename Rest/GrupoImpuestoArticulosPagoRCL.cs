...
{
    /// <summary>
    /// Cliente rest para grupo de impuesto de artículos.
    /// </summary>
    public class GrupoImpuestoArticulosPagoRCL
    {
        /// <summary>
        /// Proceso para obtener los grupos de impuesto de artículo de una compañía.
        /// </summary>
            ...
            string codigoCompania)
        {
            ...
            var reques = new RestRequest("ServicioAdministracion/api/DynamicsAx/ObtenerGrupoImpuestoArticulos", Method.GET);
            ...
            List<GrupoImpuestoArticulosPagoViewModel> items = new List<GrupoImpuestoArticulosPagoViewModel>();

            var json = JsonConvert.SerializeObject(new
            {
                origin = "ServicioAdministracion/api/DynamicsAx/ObtenerGrupoImpuestoArticulos",
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                var error = string.Format("Error al intentar consumir el servicio web \"ServicioAdministracion/api/DynamicsAx/ObtenerGrupoImpuestoArticulos\". Código de error: {0} - Descripción: {1}. " + mensaje, response.StatusCode, response.StatusDescription);

                EventLogUtil.EscribirLogErrorWeb(json, 40, sesion.OrigenLog);
            ...
            else
            {
                ...
                if (Content != null && Content.Datos != null)
                {
                    ...
                    {
                        items = JsonConvert.DeserializeObject<List<GrupoImpuestoArticulosPagoViewModel>>(Content.Datos.ToString());
                    }
                }
                else
                {
                    ...
                    {
                        var error = "Error en la respuesta obtenida al consultar el servicio: /ServicioAdministracion/api/DynamicsAx/ObtenerGrupoImpuestoArticulos";
                        EventLogUtil.EscribirLogErrorWeb(json, 40, sesion.OrigenLog);
                        throw new Exception(error);
                    }
                }
            ...
            EventLogUtil.EscribirLogInfoWeb(json, 40, sesion.OrigenLog);
