...
{
    /// <summary>
    /// Cliente rest para grupo de impuestos.
    /// </summary>
    public class GrupoImpuestoPagoRCL
    {
        /// <summary>
        /// Proceso para obtener los grupos de impuesto de una compañía.
        /// </summary>
            ...
            string codigoCompania)
        {
            ...
            var reques = new RestRequest("ServicioAdministracion/api/DynamicsAx/ObtenerGruposImpuesto", Method.GET);
            ...
            List<GrupoImpuestoPagoViewModel> items = new List<GrupoImpuestoPagoViewModel>();

            var json = JsonConvert.SerializeObject(new
            {
                origin = "ServicioAdministracion/api/DynamicsAx/ObtenerGruposImpuesto",
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                var error = string.Format("Error al intentar consumir el servicio web \"ServicioAdministracion/api/DynamicsAx/ObtenerGruposImpuesto\". Código de error: {0} - Descripción: {1}. " + mensaje, response.StatusCode, response.StatusDescription);

                EventLogUtil.EscribirLogErrorWeb(json, 39, sesion.OrigenLog);
            ...
            else
            {
                ...
                if (Content != null && Content.Datos != null)
                {
                    ...
                    {
                        items = JsonConvert.DeserializeObject<List<GrupoImpuestoPagoViewModel>>(Content.Datos.ToString());
                    }
                }
                else
                {
                    ...
                    {
                        var error = "Error en la respuesta obtenida al consultar el servicio: /ServicioAdministracion/api/DynamicsAx/ObtenerGruposImpuesto";
                        EventLogUtil.EscribirLogErrorWeb(json, 39, sesion.OrigenLog);
                        throw new Exception(error);
                    }
                }
            ...
            EventLogUtil.EscribirLogInfoWeb(json, 39, sesion.OrigenLog);
