...
{
    /// <summary>
    /// Cliente rest para impuestos vigentes.
    /// </summary>
    public class ImpuestoVigenteRCL
    {
        /// <summary>
            ...
            string CompaniaCodigo)
        {
            ...
            var reques = new RestRequest("ServicioAdministracion/api/DynamicsAx/ObtenerImpuestoVigente", Method.GET);
            ...
            {
                origin = "ServicioAdministracion/api/DynamicsAx/ObtenerImpuestoVigente",
            ...
            List<ImpuestoVigenteViewModel> impuestos = new List<ImpuestoVigenteViewModel>();
            ...
            if (response.StatusCode != System.Net.HttpStatusCode.OK)
            {
                ...
                EventLogUtil.EscribirLogErrorWeb(json, 12, sesion.OrigenLog);

                throw new Exception(string.Format("Error al intentar consumir el servicio web \"ServicioAdministracion/api/DynamicsAx/ObtenerImpuestoVigente\". Código de error: {0} - Descripción: {1}. " + mensaje, response.StatusCode, response.StatusDescription));
            }
            else
            {
                var Content = JsonConvert.DeserializeObject<RespuestaRestViewModel>(response.Content);
                ...
                if (Content != null && Content.Datos != null)
                {
                    ...
                    {
                        impuestos = JsonConvert.DeserializeObject<List<ImpuestoVigenteViewModel>>(Content.Datos.ToString());
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        throw new Exception("Error en la respuesta obtenida al consultar el servicio: /ServicioAdministracion/api/DynamicsAx/ObtenerImpuestoVigente");
                    }
                }
            }

            EventLogUtil.EscribirLogInfoWeb(json, 12, sesion.OrigenLog);
