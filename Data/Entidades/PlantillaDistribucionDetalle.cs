...
{
    public class PlantillaDistribucionDetalle
    {
        [Key]
        ...
        [ForeignKey("DistribucionCabecera")]
        public long? DistribucionCabeceraId { get; set; }
        public virtual PlantillaDistribucionCabecera DistribucionCabecera { get; set; }
